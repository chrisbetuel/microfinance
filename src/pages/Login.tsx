...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* legibility scrim — concentrated on the left, behind the card; the
          right side keeps the dawn colour */}
      ...
      <div className="absolute left-6 top-6 z-10 flex items-center gap-2.5 sm:left-10 sm:top-8">
      ...
      {/* content */}
      <div className="relative z-10 flex min-h-screen items-center justify-center px-5 py-16 lg:justify-start lg:px-[9%]">
        <div className="w-full max-w-md">
          <div className="mb-6 hidden lg:block">
            ...
            <p className="mt-3 max-w-sm text-sm text-white/70">
              Borrower files, approvals, disbursement, collections and an immutable audit trail — for microfinance
              institutions.
            </p>
          </div>

          <div className="rounded-2xl bg-white p-7 shadow-[0_30px_80px_-20px_rgba(2,6,23,0.65)] ring-1 ring-black/5 sm:p-9">
            <h2 className="text-xl font-bold tracking-tight text-slate-900">
              {mode === 'login' ? 'Welcome back' : 'Create your workspace'}
            </h2>
            <p className="mt-1 text-sm text-slate-500">
              {mode === 'login' ? 'Sign in to continue.' : 'A private, branded workspace for your institution.'}
            </p>
          ...
          <p className="mt-5 text-center text-xs text-white/55 lg:text-left">
