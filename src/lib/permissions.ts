...
export const NAV_ACCESS: Record<StaffRole, string[]> = {
  platform_admin: ['/', '/lender-setup', '/borrowers', '/products', '/applications', '/disbursement', '/repayments', '/collections', '/reports', '/security'],
  lender_admin: ['/', '/lender-setup', '/borrowers', '/products', '/applications', '/disbursement', '/repayments', '/collections', '/reports', '/security'],
  branch_manager: ['/', '/borrowers', '/products', '/applications', '/disbursement', '/repayments', '/collections', '/reports'],
  loan_officer: ['/', '/borrowers', '/applications', '/repayments', '/collections'],
  credit_committee: ['/', '/borrowers', '/applications'],
  cashier: ['/', '/borrowers', '/disbursement', '/repayments', '/collections'],
  auditor: ['/', '/lender-setup', '/borrowers', '/products', '/applications', '/disbursement', '/repayments', '/collections', '/reports', '/security'],
}
